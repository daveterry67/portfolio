...
export const MobileProjectCard = ({
  ...
  return (
    <div className="border max-w-md w-full h-[45rem] rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 overflow-hidden dark:border-gray-700">
